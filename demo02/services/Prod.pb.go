...
type ProdRequest struct {
	...
	ProdAres ProdAreas `protobuf:"varint,2,opt,name=prod_ares,json=prodAres,proto3,enum=services.ProdAreas" json:"prod_ares,omitempty"`
}
...
func (x *ProdRequest) GetProdAres() ProdAreas {
	if x != nil {
		return x.ProdAres
	}
	return ProdAreas_A
...
func (x *ProdRequestList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdRequestList) ProtoMessage() {}

func (x *ProdRequestList) ProtoReflect() protoreflect.Message {
	mi := &file_Prod_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdRequestList.ProtoReflect.Descriptor instead.
func (*ProdRequestList) Descriptor() ([]byte, []int) {
	return file_Prod_proto_rawDescGZIP(), []int{3}
}

func (x *ProdRequestList) GetProdres() []*ProdResponse {
	if x != nil {
		return x.Prodres
	}
	return nil
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x64, 0x5f, 0x61, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x41,
	0x72, 0x65, 0x61, 0x73, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x41, 0x72, 0x65, 0x73, 0x22, 0x2d,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x73, 0x12, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x69, 0x7a, 0x65, 0x1a, 0x19, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	0x50, 0x72, 0x6f, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	0x6f, 0x64, 0x65, 0x6c, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2e, 0x2f, 0x73, 0x65, 0x72,
...
var file_Prod_proto_goTypes = []interface{}{
	...
	(*ProdRequestList)(nil), // 4: services.ProdRequestList
	(*ProdModel)(nil),       // 5: services.ProdModel
}
var file_Prod_proto_depIdxs = []int32{
	0, // 0: services.ProdRequest.prod_ares:type_name -> services.ProdAreas
	2, // 1: services.ProdRequestList.prodres:type_name -> services.ProdResponse
	...
	4, // 6: services.ProdService.GetProdStocks:output_type -> services.ProdRequestList
...
type ProdServiceClient interface {
	...
	GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdRequestList, error)
...
func (c *prodServiceClient) GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdRequestList, error) {
	out := new(ProdRequestList)
...
type ProdServiceServer interface {
	...
	GetProdStocks(context.Context, *QuerySize) (*ProdRequestList, error)
...
func (*UnimplementedProdServiceServer) GetProdStocks(context.Context, *QuerySize) (*ProdRequestList, error) {
